 ...
 * - Usa try-catch para manejar errores sin detener la ejecución
 * - Puede ejecutarse múltiples veces sin duplicar datos
 * - Continúa insertando aunque algunos registros fallen
 *
...
class AllMissingDataSeeder extends Seeder
{
    ...
    public function run()
    {
        echo "🚀 Iniciando AllMissingDataSeeder (Seeder Unificado)...\n\n";

        // PARTE 1: Ciudades con IDs fijos (del MissingDataSeeder original)
        echo "📍 PARTE 1: Insertando ciudades con IDs fijos...\n";
        $citiesFixed = $this->insertCitiesWithFixedIds();
        echo "✅ Ciudades (IDs fijos) insertadas: {$citiesFixed}\n\n";

        // PARTE 2: Ciudades adicionales por nombre de county (del ExcelMissingDataSeeder)
        echo "📍 PARTE 2: Insertando ciudades adicionales por county...\n";
        $citiesAdditional = $this->insertCitiesByCountyName();
        echo "✅ Ciudades adicionales insertadas: {$citiesAdditional}\n\n";

        // PARTE 3: Todos los ZipCodes
        echo "📍 PARTE 3: Insertando zipcodes...\n";
        $zipcodesInserted = $this->insertAllZipCodes();
        echo "✅ ZipCodes insertados: {$zipcodesInserted}\n\n";

        echo "🎉 AllMissingDataSeeder completado!\n";
        echo "   Total ciudades nuevas: " . ($citiesFixed + $citiesAdditional) . "\n";
        echo "   Total zipcodes nuevos: {$zipcodesInserted}\n";

        if ($this->skipped > 0) {
            echo "   ⏭️ Registros omitidos (ya existían): {$this->skipped}\n";
        }
        if ($this->errors > 0) {
            echo "   ⚠️ Errores encontrados (continuó la ejecución): {$this->errors}\n";
        }
    }
    ...
    private function safeInsert(string $table, array $data, string $identifier = ''): bool
    {
        try {
            ...
            if (strpos($e->getMessage(), 'Duplicate') === false) {
                echo "   ⚠️ Error insertando {$identifier}: " . substr($e->getMessage(), 0, 100) . "\n";
            }
            return false;
        }
    }
    ...
    private function insertCitiesWithFixedIds(): int
    {
        ...
        foreach ($cities as $city) {
            try {
                ...
                // También verificar por nombre y county para evitar duplicados
    ...
    private function insertCitiesByCountyName(): int
    {
        $missingCities = [
            ...
            // SAN FRANCISCO
            ['name' => 'San Francisco', 'county_name' => 'San Francisco County'],
            ['name' => 'Marin County', 'county_name' => 'Marin County, CA'],
            ['name' => 'Oakland', 'county_name' => 'Oakland, CA'],
            ['name' => 'Alameda', 'county_name' => 'Alameda, CA'],
            ['name' => 'San Mateo County', 'county_name' => 'San Mateo County, CA'],
            ['name' => 'Santa Clara County', 'county_name' => 'Santa Clara County, CA'],
        ];
    ...
    private function insertAllZipCodes(): int
    {
        ...
        $zipsByName = [
            ...
            // SAN FRANCISCO
            'San Francisco' => ['94102', '94103', '94104', '94105', '94107', '94108', '94109', '94110', '94111', '94112', '94114', '94115', '94116', '94117', '94118', '94121', '94122', '94123', '94124', '94127', '94129', '94130', '94131', '94132', '94133', '94134'],
            'Marin County' => ['94901', '94903', '94904', '94920', '94924', '94925', '94929', '94930', '94933', '94937', '94938', '94941', '94945', '94947', '94949', '94960', '94965'],
            'Oakland' => ['94601', '94602', '94603', '94605', '94606', '94607', '94608', '94609', '94610', '94611', '94612', '94618', '94619', '94621'],
            'Alameda' => ['94501', '94502'],
            'San Mateo County' => ['94002', '94005', '94010', '94014', '94015', '94016', '94017', '94018', '94019', '94020', '94025', '94027', '94028', '94030', '94061', '94062', '94063', '94064', '94065', '94401', '94402', '94403', '94404', '94497'],
            'Santa Clara County' => ['94080', '94083', '94085', '94087', '94301', '94303', '94304', '94306', '95002', '95008', '95014', '95032', '95035', '95050', '95051', '95054', '95070', '95110', '95111', '95112', '95113', '95116', '95117', '95118', '95119', '95120', '95121', '95122', '95123', '95124', '95125', '95126', '95127', '95128', '95129', '95130', '95131', '95132', '95133', '95134', '95135', '95136', '95138', '95139', '95140', '95148'],
        ];
