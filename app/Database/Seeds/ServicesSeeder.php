 ...
 *
 * Ejecutar con: php spark db:seed ServicesSeeder
 */
class ServicesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        echo "🎉 ServicesSeeder completado!\n";
    ...
    private function insertServices(): int
    {
        $services = [
            ...
            [
                ...
                'img' => 'img/junior-jammer-mashup.jpg',
                'is_active' => true,
            ],
            [
